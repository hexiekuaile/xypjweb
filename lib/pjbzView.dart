...
class PjbzView extends StatefulWidget {
  @override
  _PjbzViewState createState() => _PjbzViewState();
}

class _PjbzViewState extends State<PjbzView> {
  // //默认一页行数
  ...
  List<DataColumn> getColumn() {
    return [
      DataColumn(
          label: Text('分类'),
          onSort: (i, b) {
            _sort<String>((Mybean p) => p.a, i, b);
          }),
      DataColumn(
          label: Text('指标名称'),
          onSort: (i, b) {
            _sort<String>((Mybean p) => p.b, i, b);
          }),
      DataColumn(
          label: Text('性别'),
          onSort: (i, b) {
            _sort<String>((Mybean p) => p.c, i, b);
          }),
      DataColumn(
          numeric: true,
          label: Text('分值'),
          onSort: (i, b) {
            _sort((Mybean p) => p.d, i, b);
          }),
    ];
  }
}
