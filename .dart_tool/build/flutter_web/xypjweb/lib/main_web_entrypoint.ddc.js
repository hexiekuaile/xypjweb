define(['dart_sdk', 'packages/xypjweb/main'], function(dart_sdk, packages__xypjweb__main) {
  'use strict';
  ...
  const main = packages__xypjweb__main.main;
  ...
  dart.trackLibraries("packages/xypjweb/main_web_entrypoint", {
    "package:xypjweb/main_web_entrypoint.dart": main_web_entrypoint
  }, {
