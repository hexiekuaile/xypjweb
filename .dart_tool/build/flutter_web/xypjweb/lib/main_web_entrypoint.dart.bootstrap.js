...
define("main_web_entrypoint.dart.bootstrap", ["packages/xypjweb/main_web_entrypoint", "dart_sdk"], function(app, dart_sdk) {
  ...
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        ...
        if (childName === "package:xypjweb/main_web_entrypoint.dart") {
          // Clear static caches.
