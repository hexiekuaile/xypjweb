define(['dart_sdk', 'packages/typed_data/typed_buffers'], function(dart_sdk, packages__typed_data__typed_buffers) {
  ...
  diagnostics$.DiagnosticsNode = class DiagnosticsNode extends core.Object {
    ...
    static message(message, opts) {
      ...
      if (!(style != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 1434, 12, "),\r\n         ");
      if (!(level != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 1435, 12, "ostic nodes m");
    ...
    toString(opts) {
      ...
      if (!(this.style != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 1630, 12, " string repre");
      if (!(minLevel != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 1631, 12, "is diagnostic th");
    ...
    get textTreeConfiguration() {
      if (!(this.style != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 1648, 12, "   }\r\n    ass");
      switch (this.style) {
        case C6 || CT.C6:
        {
          return null;
  ...
  (diagnostics$.DiagnosticsNode.new = function(opts) {
    ...
    if (!(showName != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 1407, 15, "line string dump");
    if (!(showSeparator != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 1408, 15, "]. The core members a");
    if (!(name == null || !name[$endsWith](":"))) dart.assertFailed("Names of diagnostic nodes must not end with colons.\n" + "name:\n" + "  \"" + dart.str(name) + "\"", "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 1413, 10, "\r\n/// In release mode, far less inf");
    ;
  ...
  diagnostics$.DiagnosticsProperty$ = dart.generic(T => {
    class DiagnosticsProperty extends diagnostics$.DiagnosticsNode {
      ...
      [_addTooltip](text) {
        if (!(text != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 2725, 12, "on }) {\r\n   ");
      ...
      [_maybeCacheValue]() {
        ...
        if (!(this[_computeValue] != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 2795, 12, "null and the exceptio");
        try {
    ...
    (DiagnosticsProperty.new = function(name, value, opts) {
      ...
      if (!(showName != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 2563, 15, "ave a lower or h");
      if (!(showSeparator != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 2564, 15, ". For example, if the");
      if (!(style != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 2565, 15, " null and [mi");
      if (!(level != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 2566, 15, " /// true, [l");
    ...
    (DiagnosticsProperty.lazy = function(name, computeValue, opts) {
      ...
      this[allowWrap$] = allowWrap;
      this[allowNameWrap$] = allowNameWrap;
      if (!(showName != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 2609, 15, "r or higher\r\n  /");
      if (!(showSeparator != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 2610, 15, "ple, if calling `comp");
      if (!(dart.equals(defaultValue, diagnostics$.kNoDefaultValue) || T.is(defaultValue))) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 2611, 15, "n exception, [level]\r\n  /// will always return [Diag");
      if (!(missingIfNull != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 2612, 15, ".\r\n  DiagnosticsPrope");
      if (!(style != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 2613, 15, "ing name,\r\n  ");
      if (!(level != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 2614, 15, "alueCallback<");
      this[_description] = description;
    ...
    class DiagnosticableMixin extends Object {
      ...
      toString(opts) {
        ...
        if (!dart.test(dart.fn(() => {
          ...
          return true;
        }, VoidTobool())())) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 3095, 12, " describes the children of a node properly or a node has\r\n///    no children.\r\n///  * [DiagnosticsProperty], which should be used to create l");
        t3 = fullString;
  ...
  diagnostics$.DiagnosticableNode$ = dart.generic(T => {
    ...
    (DiagnosticableNode.new = function(opts) {
      ...
      this[value$] = value;
      if (!(value != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 2882, 15, "ticsNode) {\r\n");
    ...
    render(node, opts) {
      ...
      if (dart.test(children[$isNotEmpty]) && dart.test(config.showChildren)) {
        ...
        for (let i = 0; i < dart.notNull(children[$length]); i = i + 1) {
          ...
          if (!(child != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 1332, 16, "children.isEm");
  ...
  (diagnostics$.MessageProperty.new = function(name, message, opts) {
    let style = opts && 'style' in opts ? opts.style : C3 || CT.C3;
    let level = opts && 'level' in opts ? opts.level : C1 || CT.C1;
    if (!(name != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 1760, 15, "ssage], whic");
    if (!(message != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 1761, 15, "role for messag");
    if (!(style != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 1762, 15, " a clear prop");
    if (!(level != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 1763, 15, " [StringPrope");
  ...
  (diagnostics$.StringProperty.new = function(name, value, opts) {
    ...
    if (!(quoted != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 1789, 15, "ch is a better");
    if (!(style != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 1790, 15, " message\r\n///");
    if (!(level != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 1791, 15, "cribing a pro");
  ...
  (diagnostics$.DoubleProperty.new = function(name, value, opts) {
    ...
    let style = opts && 'style' in opts ? opts.style : C3 || CT.C3;
    let level = opts && 'level' in opts ? opts.level : C1 || CT.C1;
    if (!(showName != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 1925, 15, " }\r\n}\r\n/// Prope");
    if (!(style != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 1926, 15, "double] [valu");
    if (!(level != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 1927, 15, "l [unit] of m");
  ...
  (diagnostics$.DoubleProperty.lazy = function(name, computeValue, opts) {
    ...
    let defaultValue = opts && 'defaultValue' in opts ? opts.defaultValue : C2 || CT.C2;
    let level = opts && 'level' in opts ? opts.level : C1 || CT.C1;
    if (!(showName != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 1955, 15, "ifNull: ifNull,\r");
    if (!(level != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 1956, 15, "    tooltip: ");
  ...
  (diagnostics$.IntProperty.new = function(name, value, opts) {
    ...
    let style = opts && 'style' in opts ? opts.style : C3 || CT.C3;
    let level = opts && 'level' in opts ? opts.level : C1 || CT.C1;
    if (!(showName != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 1988, 15, "l: level,\r\n  );\r");
    if (!(level != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 1989, 15, "String number");
    if (!(style != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 1990, 15, "gFormatDouble");
  ...
  (diagnostics$.PercentProperty.new = function(name, fraction, opts) {
    ...
    let unit = opts && 'unit' in opts ? opts.unit : null;
    let level = opts && 'level' in opts ? opts.level : C1 || CT.C1;
    if (!(showName != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 2024, 15, "n 0 and 1 and fo");
    if (!(level != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 2025, 15, " percentage.\r");
  ...
  (diagnostics$.FlagProperty.new = function(name, opts) {
    ...
    if (!(showName != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 2105, 15, "* [ObjectFlagPro");
    if (!(level != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 2106, 15, "ides similar ");
    if (!(ifTrue != null || ifFalse != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 2107, 15, "g whether\r\n///    a [value] is nu");
  ...
  diagnostics$.IterableProperty$ = dart.generic(T => {
    ...
    (IterableProperty.new = function(name, value, opts) {
      ...
      let showSeparator = opts && 'showSeparator' in opts ? opts.showSeparator : true;
      let level = opts && 'level' in opts ? opts.level : C1 || CT.C1;
      if (!(style != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 2203, 15, "displayed. If");
      if (!(showName != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 2204, 15, "null that indica");
      if (!(showSeparator != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 2205, 15, " empty iterable [valu");
      if (!(level != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 2206, 15, "ing to displa");
  ...
  diagnostics$.EnumProperty$ = dart.generic(T => {
    ...
    (EnumProperty.new = function(name, value, opts) {
      let defaultValue = opts && 'defaultValue' in opts ? opts.defaultValue : C2 || CT.C2;
      let level = opts && 'level' in opts ? opts.level : C1 || CT.C1;
      if (!(level != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 2286, 15, " return json;");
  ...
  diagnostics$.ObjectFlagProperty$ = dart.generic(T => {
    ...
    (ObjectFlagProperty.new = function(name, value, opts) {
      ...
      if (!(ifPresent != null || ifNull != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 2338, 15, "nctionality describing whether\r\n///");
      if (!(showName != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 2339, 15, "rue or false.\r\nc");
      if (!(level != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 2340, 15, "perty<T> exte");
    ...
    (ObjectFlagProperty.has = function(name, value, opts) {
      let level = opts && 'level' in opts ? opts.level : C1 || CT.C1;
      if (!(name != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 2359, 15, "ing ifNull,\r");
      if (!(level != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 2360, 15, " = false,\r\n  ");
  ...
  diagnostics$.FlagsSummary$ = dart.generic(T => {
    class FlagsSummary extends diagnostics$.DiagnosticsProperty$(core.Map$(core.String, T)) {
      valueToString(opts) {
        let parentConfiguration = opts && 'parentConfiguration' in opts ? opts.parentConfiguration : null;
        if (!(this.value != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 2471, 12, "ue], [showNam");
    ...
    (FlagsSummary.new = function(name, value, opts) {
      ...
      let showSeparator = opts && 'showSeparator' in opts ? opts.showSeparator : true;
      let level = opts && 'level' in opts ? opts.level : C1 || CT.C1;
      if (!(value != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 2456, 15, "only one flag");
      if (!(showName != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 2457, 15, " if there is onl");
      if (!(showSeparator != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 2458, 15, " * [IterableProperty]");
      if (!(level != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 2459, 15, "imilar functi");
  ...
  diagnostics$.describeEnum = function describeEnum(enumEntry) {
    ...
    if (!(indexOfDot !== -1 && indexOfDot < description.length - 1)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/foundation/diagnostics.dart", 2990, 10, "';\r\n\r\n// This method exists as a workaround for https:/");
